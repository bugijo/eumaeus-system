describe('Teste na Porta 3000', () => {
  ...
  it('deve conseguir acessar a aplicação na porta 3000', () => {
    ...
    cy.screenshot('aplicacao-carregada-3000');
  });
  ...
  it('deve conseguir navegar para a página de clientes', () => {
    ...
    // Captura screenshot
    cy.screenshot('pagina-clientes-3000');
  });
});