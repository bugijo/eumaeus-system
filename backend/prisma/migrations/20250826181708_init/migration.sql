...
CREATE TABLE "ClinicSettings" (
    ...
    "appointmentReminderTemplate" TEXT NOT NULL DEFAULT 'Olá {tutor}! Não se esqueça da consulta do {pet} amanhã às {hora}. Até logo!',
    "vaccineRemindersEnabled" BOOLEAN NOT NULL DEFAULT true,
    "vaccineReminderTemplate" TEXT NOT NULL DEFAULT 'Olá {tutor}! A vacina {vacina} do {pet} está próxima do vencimento em {data}. Agende a revacinação!',
    "emailFromName" TEXT NOT NULL DEFAULT 'PulseVet Clínica Veterinária',
    "emailFromAddress" TEXT NOT NULL DEFAULT 'contato@pulsevet.com.br',
    "clinicName" TEXT NOT NULL DEFAULT 'PulseVet Clínica Veterinária',
    "clinicPhone" TEXT NOT NULL DEFAULT '(11) 99999-9999',
    "clinicAddress" TEXT NOT NULL DEFAULT 'Rua das Flores, 123 - São Paulo, SP',
    "reminderSendTime" TEXT NOT NULL DEFAULT '08:00',
    "vaccineReminderDaysBefore" INTEGER NOT NULL DEFAULT 7,
    "clinicId" INTEGER NOT NULL DEFAULT 1
);
