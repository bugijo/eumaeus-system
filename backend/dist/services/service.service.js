...
class ServiceService {
    ...
    static getServicesByCategoryName(category) {
        return this.SERVICES.filter(service => service.category.toLowerCase() === category.toLowerCase() && service.active);
    }
    static searchServices(query) {
        const searchTerm = query.toLowerCase();
        return this.SERVICES.filter(service => service.active && (service.name.toLowerCase().includes(searchTerm) ||
